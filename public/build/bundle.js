...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h1 = element("h1");
    			t0 = text("My Goal is to : ");
    			t1 = text(/*goal*/ ctx[0]);
    			attr_dev(h1, "class", "svelte-1o3vjvb");
    			toggle_class(h1, "empahsised", /*goal*/ ctx[0].includes('!'));
    			add_location(h1, file$1, 5, 4, 51);
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*goal*/ 1) set_data_dev(t1, /*goal*/ ctx[0]);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (goal === undefined && !('goal' in $$props || $$self.$$.bound[$$self.$$.props['goal']])) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			span = element("span");
    			span.textContent = "Course Goal:";
    			t1 = space();
    			textarea = element("textarea");
    			t2 = space();
    			create_component(output.$$.fragment);
    			add_location(span, file, 7, 1, 107);
    			attr_dev(textarea, "rows", "3");
    			attr_dev(textarea, "cols", "20");
    			add_location(textarea, file, 8, 1, 135);
    			add_location(div, file, 6, 0, 100);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(textarea, /*goal*/ ctx[0]);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*goal*/ 1) output_changes.goal = /*goal*/ ctx[0];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Output, goal });
    	...
    	return [goal, textarea_input_handler];
    }
