...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$1, 22, 6, 455);
    			attr_dev(div0, "class", "thumb svelte-p7z0xn");
    			toggle_class(div0, "thumb-placeholder", !/*userImage*/ ctx[3]);
    			add_location(div0, file$1, 21, 4, 392);
    			attr_dev(h1, "class", "svelte-p7z0xn");
    			add_location(h1, file$1, 25, 6, 539);
    			attr_dev(h2, "class", "svelte-p7z0xn");
    			add_location(h2, file$1, 26, 6, 565);
    			attr_dev(div1, "class", "user-data svelte-p7z0xn");
    			add_location(div1, file$1, 24, 4, 509);
    			attr_dev(header, "class", "svelte-p7z0xn");
    			add_location(header, file$1, 20, 2, 379);
    			add_location(p, file$1, 30, 4, 640);
    			attr_dev(div2, "class", "description svelte-p7z0xn");
    			add_location(div2, file$1, 29, 2, 610);
    			add_location(button, file$1, 33, 4, 695);
    			attr_dev(div3, "class", "deleteButton");
    			add_location(div3, file$1, 32, 2, 664);
    			attr_dev(div4, "class", "contact-card svelte-p7z0xn");
    			add_location(div4, file$1, 19, 0, 350);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*handleDelete*/ ctx[4], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*bio*/ 4) set_data_dev(t5, /*bio*/ ctx[2]);
    		},
    		i: noop,
    		o: noop,
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (userName === undefined && !('userName' in $$props || $$self.$$.bound[$$self.$$.props['userName']])) {
    			console_1$1.warn("<ContactCard> was created without expected prop 'userName'");
    		}

    		if (jobTitle === undefined && !('jobTitle' in $$props || $$self.$$.bound[$$self.$$.props['jobTitle']])) {
    			console_1$1.warn("<ContactCard> was created without expected prop 'jobTitle'");
    		}

    		if (bio === undefined && !('bio' in $$props || $$self.$$.bound[$$self.$$.props['bio']])) {
    			console_1$1.warn("<ContactCard> was created without expected prop 'bio'");
    		}

    		if (userImage === undefined && !('userImage' in $$props || $$self.$$.bound[$$self.$$.props['userImage']])) {
    			console_1$1.warn("<ContactCard> was created without expected prop 'userImage'");
    		}

    		if (id === undefined && !('id' in $$props || $$self.$$.bound[$$self.$$.props['id']])) {
    			console_1$1.warn("<ContactCard> was created without expected prop 'id'");
    		}
    	});

    	const writable_props = ['userName', 'jobTitle', 'bio', 'userImage', 'id'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<ContactCard> was created with unknown prop '${key}'`);
    	});
    	...
    	return [userName, jobTitle, bio, userImage, handleDelete, id];
    }
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(76:0) {#if formState === false}",
    		ctx
    	});
    ...
    // (80:0) {#each contactList as item, i}
    function create_each_block(ctx) {
    	...
    	let h21;
    	let t3;
    	let t4_value = /*item*/ ctx[16].ID + "";
    	let t4;
    	let t5;
    	let contactcard;
    	let current;

    	function deleteContact_handler() {
    		return /*deleteContact_handler*/ ctx[14](/*item*/ ctx[16]);
    	}

    	contactcard = new ContactCard({
    			props: {
    				id: /*item*/ ctx[16].ID,
    				userName: /*item*/ ctx[16].userName,
    				jobTitle: /*item*/ ctx[16].title,
    				bio: /*item*/ ctx[16].description,
    				userImage: /*item*/ ctx[16].image
    			},
    			$$inline: true
    		});

    	contactcard.$on("deleteContact", deleteContact_handler);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h20, file, 80, 2, 2213);
    			add_location(h21, file, 81, 2, 2236);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty & /*contactList*/ 32) && t4_value !== (t4_value = /*item*/ ctx[16].ID + "")) set_data_dev(t4, t4_value);
    			const contactcard_changes = {};
    			if (dirty & /*contactList*/ 32) contactcard_changes.id = /*item*/ ctx[16].ID;
    			if (dirty & /*contactList*/ 32) contactcard_changes.userName = /*item*/ ctx[16].userName;
    			if (dirty & /*contactList*/ 32) contactcard_changes.jobTitle = /*item*/ ctx[16].title;
    			if (dirty & /*contactList*/ 32) contactcard_changes.bio = /*item*/ ctx[16].description;
    			if (dirty & /*contactList*/ 32) contactcard_changes.userImage = /*item*/ ctx[16].image;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(80:0) {#each contactList as item, i}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file, 54, 4, 1427);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "userName");
    			add_location(input0, file, 55, 4, 1471);
    			attr_dev(div0, "class", "form-control");
    			add_location(div0, file, 53, 2, 1396);
    			attr_dev(label1, "for", "jobTitle");
    			add_location(label1, file, 58, 4, 1571);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "id", "jobTitle");
    			add_location(input1, file, 59, 4, 1615);
    			attr_dev(div1, "class", "form-control");
    			add_location(div1, file, 57, 2, 1540);
    			attr_dev(label2, "for", "image");
    			add_location(label2, file, 62, 4, 1712);
    			attr_dev(input2, "type", "text");
    			attr_dev(input2, "id", "image");
    			add_location(input2, file, 63, 4, 1753);
    			attr_dev(div2, "class", "form-control");
    			add_location(div2, file, 61, 2, 1681);
    			attr_dev(label3, "for", "desc");
    			add_location(label3, file, 66, 4, 1847);
    			attr_dev(textarea, "rows", "3");
    			attr_dev(textarea, "id", "desc");
    			add_location(textarea, file, 67, 4, 1889);
    			attr_dev(div3, "class", "form-control");
    			add_location(div3, file, 65, 2, 1816);
    			attr_dev(div4, "id", "form");
    			attr_dev(div4, "class", "svelte-pd4ajg");
    			add_location(div4, file, 52, 0, 1378);
    			add_location(button0, file, 71, 0, 1963);
    			add_location(button1, file, 72, 0, 2024);
    			add_location(button2, file, 73, 0, 2074);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*contactList, deleteById*/ 544) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function showContactInfo() {
    		if (userName.trim().length === 0 || title.trim().length === 0 || image.trim().length === 0 || description.trim().length === 0) {
    			...
    			contactList.sort((a, b) => b.ID - a.ID);
    	...
    	function delLast() {
    		$$invalidate(5, contactList = contactList.slice(0, -1));
    	}

    	function deleteById(delId) {
    		$$invalidate(5, contactList = contactList.filter(contact => contact.ID != delId));
    	}
    	...
    	const deleteContact_handler = item => deleteById(item.ID);
